...
from collections import defaultdict #allow acces to keys that not exist

import matplotlib.pyplot as plt  #drawing plots
import numpy as np
import seaborn as sns
from matplotlib.patches import Patch  #drw shaped
...
# ------------------------------
#
# Let’s build a ``Q-learning agent`` to solve *CountersGame-v0*! We’ll need
...
class BlackjackAgent:
    ...
    def get_action(self, obs: tuple[int, int, bool]) -> int:
        ...
        #q-value function is used to estimate the optimal action that we need 
        #to take in each step. It is the one that maximizes the long term reward
